...
import Card3Logo from '../Level1Components/Img/Card3Logo.png'

export default function Level1Card3() {
    return (
        <>
                    ...
                    <Stack height='100%' width='100%' direction='column' display='flex' justifyContent='center' alignItems='center'>
                        ...
                        <Box height='17%' width='100%' display='flex' justifyContent='center' alignItems='center' borderBottom={3} borderColor='#d7e0e0' paddingX={2} boxSizing='border-box' >
                            <Stack height='100%' width='100%' direction='row' display='flex' justifyContent='space-between' alignItems='center'>
                                <Typography component='h3' fontSize='0.9rem' fontWeight='600' fontFamily='Poppins' color='#788588' >TOP TRANSACTIONS</Typography>
                        ...
                        <Stack height='83%' width='100%' direction='column' display='flex' justifyContent='center' alignItems='center' paddingX={2} boxSizing='border-box' >
                            ...
                            <Stack height='25%' width='100%' direction='row' display='flex' justifyContent='space-between' alignItems='center'>
                                <Stack height='100%' width='80%' direction='column' display='flex' justifyContent='center' alignItems='flex-start'>
                                    <Typography component='h3' fontSize='0.9rem' fontWeight='700' fontFamily='Poppins' color='#263133' >InteliJ IDEA</Typography>
                                ...
                                <Stack height='100%' width='20%' direction='column' display='flex' justifyContent='center' alignItems='flex-end' marginRight={0.4}>
                                    ...
                                    <Typography component='h3' fontSize='0.9rem' fontWeight='700' fontFamily='Poppins' color='#263133' >08</Typography>
                                </Stack>
                            </Stack>
                            ...
                            <Stack height='75%' width='100%' direction='row' display='flex' justifyContent='space-between' alignItems='center'>
                                <Stack height='100%' width='40%' direction='column' display='flex' justifyContent='center' alignItems='center'>
                                    <Box component='img' alt='InteliJ WebStrom Logo' src={Card3Logo} />
                                </Stack>
                                <Stack height='100%' width='60%' direction='row' display='flex' justifyContent='center' alignItems='flex-end' marginRight={0.4}>
                                    ...
                                    <Stack height='100%' width='50%' direction='column' spacing={1} display='flex' justifyContent='center' alignItems='flex-end'>
                                        <Typography component='h3' fontSize='0.7rem' fontWeight='700' fontFamily='Poppins' color='#263133' display='flex' justifyContent='center' alignItems='center'>32 <ArrowDropUpIcon color='success' /></Typography>
                                        <Typography component='h3' fontSize='0.7rem' fontWeight='700' fontFamily='Poppins' color='#263133' display='flex' justifyContent='center' alignItems='center'>08 <ArrowDropUpIcon color='success' /></Typography>
                                        <Typography component='h3' fontSize='0.7rem' fontWeight='700' fontFamily='Poppins' color='#263133' display='flex' justifyContent='center' alignItems='center'>23.3% <ArrowDropDownIcon color='error' /></Typography>
                                        <Typography component='h3' fontSize='0.7rem' fontWeight='700' fontFamily='Poppins' color='#263133' display='flex' justifyContent='center' alignItems='center'>$113.2 <ArrowDropDownIcon color='error' /></Typography>
                                    </Stack>
                                </Stack>
                            </Stack>
                        </Stack>
